...
use app\models\AppovalRulesNodeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AppovalRuleNodeController implements the CRUD actions for AppovalRulesNode model.
 */
class AppovalRuleNodeController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new AppovalRulesNodeSearch();
