...
use app\models\AppovalRulesEdgeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AppovalRuleEdgeController implements the CRUD actions for ApprovalRulesEdge model.
 */
class AppovalRuleEdgeController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new AppovalRulesEdgeSearch();
