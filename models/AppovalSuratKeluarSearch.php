...
/**
 * AppovalSuratKeluarSearch represents the model behind the search form of `app\models\ApprovalSuratKeluar`.
 */
class AppovalSuratKeluarSearch extends ApprovalSuratKeluar
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = ApprovalSuratKeluar::find();
